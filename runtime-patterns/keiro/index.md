...
- [Typed projection catalogs and rebuild groups](projection-catalogs.md) - One validated projection inventory, catalog-derived live writers, dependency-group fencing, and deterministic resumable rebuilds
