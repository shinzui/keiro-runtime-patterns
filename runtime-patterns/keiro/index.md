...
- [Keiro runtime patterns](overview.md) - Index of prescriptive Keiro runtime and DSL standards, including the post-0.11 typed projection catalog release gate
...
- [Read models and projections](read-models-and-projections.md) - Typed projection catalogs, group fencing, deterministic resumable rebuilds, consistency, and snapshot limits
