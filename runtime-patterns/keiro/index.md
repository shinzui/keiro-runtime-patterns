...
- [Brownfield Keiro Adoption](brownfield-adoption.md) - Adopting Keiro around existing domain types and stored JSON with structural mappings, codec evidence, and replay-safe cutover gates
- [Keiro-dsl adoption](dsl-adoption.md) - When to adopt keiro-dsl, including brownfield structural mappings, the generated-code firewall, conformance evidence, and evolution gates
...
- [Evolution gates and rollout ordering](evolution-and-rollout.md) - The six-layer evolution gate model, compatibility vectors, structural mapping evidence, replay audits, and durable-value rollout ordering
